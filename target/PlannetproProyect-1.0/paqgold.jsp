<%-- 
    Document   : paqgold
    Created on : 16 abr 2024, 0:34:48
    Author     : macuser
--%>
...
<head>
    <title>PlannetPro-Paquete Gold Info</title>
    <meta charset="utf-8">
...
<body>
  ...
  <img class="card-img-top" src="./assets/img/Plannet_packca.png" alt="Card image cap">
  <div class="card-body">
...
<div class="row" style="margin-left: 140px;">
    ...
    function enviarSeleccion() {
        ...
        var seleccionUsuario = 3; // Esto es un ejemplo, debes obtener la selección del usuario según tu lógica
